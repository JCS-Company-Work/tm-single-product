<?php
    ...
    // use TMSingleProduct\Images\TMSP_Images; // Removed - composite image class no longer exists
    ...
    class TMSP_Gallery {
        ...
        public static function renderCompositeImage() {
            ...
            $images = class_exists('TMSingleProduct\Images\TMSP_Images') ? TMSP_Images::getCompositeImages() : null;
