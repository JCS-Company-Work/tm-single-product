...
namespace TMSingleProduct\Gallery;
...
class TMSP_GalleryAssets {
    ...
    public static function enqueue_assets() {
        ...
        wp_register_script_module(
            'photoswipe',
            TMSP_URL . 'assets/js/gallery/photoswipe/photoswipe.esm.min.js',
            [],
            TMSP_VERSION
        );
        ...
        wp_register_script_module(
            'photoswipe-lightbox',
            TMSP_URL . 'assets/js/gallery/photoswipe/photoswipe-lightbox.esm.min.js',
            ['photoswipe'],
            TMSP_VERSION
        );
        ...
        wp_enqueue_script_module(
            'tm-gallery-js',
            TMSP_URL . 'assets/js/gallery/TMGallery.js',
            ['photoswipe-lightbox'],
            TMSP_VERSION
        );
        ...
        wp_enqueue_style(
            'tm-photoswipe',
            TMSP_URL . 'assets/css/gallery/photoswipe.css',
            [],
            TMSP_VERSION
        );
    }
